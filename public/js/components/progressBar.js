...
const ProgressBarSystem = {
    ...
    createProgressBar() {
        ...
        // Find or create container in gameplay area
        ...
        // Insert at top of gameplay area
        const questionCard = gameplayArea.querySelector('.question-card');
        if (questionCard) {
            gameplayArea.insertBefore(progressContainer, questionCard);
        } else {
            gameplayArea.insertBefore(progressContainer, gameplayArea.firstChild);
        }
    },
